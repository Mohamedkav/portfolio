      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            I'm a passionate QA Engineer with expertise in modern web technologies. I love creating digital
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p className="text-pretty">
                With a strong foundation in manual and autotmation testing, I specialize in testing and validating 
                applications using Selenium, Jira and modern technologies.
              </p>
              <p className="text-pretty">
              ...
              <p className="text-pretty">
                ...
                or sharing knowledge with the testing community.
              </p>
            </div>
          </motion.div>
